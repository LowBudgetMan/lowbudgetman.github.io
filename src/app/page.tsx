    ...
    <main className={styles.container}>
      <section className={styles.section}>
        <div className={styles.flexColumn}>
          ...
          <h2 className={`${styles.sectionTitle} ${homeStyles.tagline}`}><span className={styles.about}>Software Engineer</span><span className={styles.projects}>Product Architect</span><span className={styles.blog}>Tinkerer</span>
          </h2>
      ...
      <section className={styles.section}>
        ...
        <div className={styles.flexColumn}>
          <div className={styles.card}>
            ...
            <p className={styles.cardContent}>
              Exploring how team names in organizations function similarly to stock tickers - they should be memorable, 
